/*
**********************************************************
Nombre de la clase:	    Crypto
Proposito:				Manejo de encriptaciona simetrica publica + redes de feistel
Fecha de Creacion:		17 - 07 - 19
Version:				1
Autor:					Franky
**********************************************************
*/
//var Bar = require("./Barrett");
//var Bar = require("./BigInt");
...
(function (global, factory) {
    ...
    var alfabeto = "0123456789. qwertyuiopasdfghjklzxcvbnmQWERTYUIOPASDFGHJKLZXCVBNM";
    var vueltas = 2;
    var encryptionExponent = "0";
    var decryptionExponent = "0";
    var modulus = "0";
    var permutacion = '0';
    var k = '0';
    var x = 1;//para definir si se encripta o no
    var key;

    function Crypto(berp){
        encryptionExponent = berp.e;
        modulus = berp.m;
        permutacion = berp.p;
        k = berp.k;
    ...
    function Encriptar (s){
        return EncriptarFeistel(encryptedString(s));
    }

    function EncriptarFeistel (original){

        var vueltas=2;
        //creamos el modelo de columnas
        var tamano_bloque = permutacion.length;
        var tamano_total =original.length
        //desarma el texto original
        var aux = desarmar(original,tamano_bloque,tamano_total);
        //muestra resultados
        for(let i = 0;i < vueltas;i++ ){
            aux=sustitucion(aux,k)
    ...
    function sustitucion (Vec,k){
        ...
        for(var i =0; i < Vec.length; i ++){
            if(i%2==1){
                ...
                Vec2[i]=SustituirCadena(Vec[i],k);
            }
    ...
    function SustituirCadena (cadena,k){
        var aux='';
    ...
    function encryptedString (s){
        ...
        for (i = 0; i < al; i += key.chunkSize) {
            ...
            var text = key.radix == 16 ? biToDecimal(crypt) : biToString(crypt, key.radix);
            result += text + ".";
        }
    ...
    function RSAKeyPair(encryptionExponent, decryptionExponent, modulus){
        ...
        //console.log('RSAKeyPair', encryptionExponent,decryptionExponent, modulus)
...
// lr10 = 10 ^ dpl10
    ...
    if (typeof module !== 'undefined' && module.exports) {
        module.exports.Crypterp = global.Crypterp;
    }
    else if (typeof define === 'function' && define.amd) {
        // AMD. Register as an anonymous module.
        define([], function(){ return global.Crypterp });
    }
    // that's it!
    return {Crypterp: global.Crypterp}
