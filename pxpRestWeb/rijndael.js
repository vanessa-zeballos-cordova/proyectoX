...
//public
    ...
    var Encrypt=function(block, key) {
        crypt(block,key,true);
    }
    var Decrypt=function(block, key) {
...
//private
    ...
    if (typeof module !== 'undefined' && module.exports) {
        module.exports.Rijndael = global.Rijndael;
    }
    else if (typeof define === 'function' && define.amd) {
        // AMD. Register as an anonymous module.
        define([], function(){ return global.Rijndael });
    }
    // that's it!
    return {Rijndael: global.Rijndael}
}));