...
(function (global, factory) {
    ...
    function BigInteger(flag)
    {
        ...
        if (typeof flag == "boolean" && flag == true) {
            ...
            that.digits = ZERO_ARRAY.slice(0);
        }
        that.isNeg = false;
    }
    ...
    if (typeof module !== 'undefined' && module.exports) {
        module.exports.BigInt = global.BigInt;
    }
    else if (typeof define === 'function' && define.amd) {
        // AMD. Register as an anonymous module.
        define([], function(){ return global.BigInt });
    }
    // that's it!
    return {BigInt: global.BigInt}
