...
class BarrettMu {
    ...
    BarrettMu(m) {
        ...
        this.b2k = new BigInt.BigInteger();

        b2k.digits[2 * this.k] = 1; // b2k = b^(2k)
        this.mu = BigInt.biDivide(b2k, this.modulus);
        this.bkplus1 = new BigInt.BigInteger();
    ...
    BarrettMu_powMod(x, y) {
        var result = new BigInt.BigInteger();
        result.digits[0] = 1;
        var a = x;
        var k = y;
        while (true) {
...
module.exports = BarrettMu;
    ...
    if (typeof module !== 'undefined' && module.exports) {
        module.exports.Barrett = global.Barrett;
    }
    else if (typeof define === 'function' && define.amd) {
        // AMD. Register as an anonymous module.
        define([], function(){ return global.Barrett });
    }
    // that's it!
    return {Barrett: global.Barrett}
